      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          <!-- <tr>
            <th scope="row">1</th>
            <td>Mark</td>
            <td width="1"><a href="edit.php" class="btn btn-success">Edit</a></td>
            <td width="1"><a href="delete.php" class="btn btn-danger">Delete</a></td>
          </tr> -->
          <?php
            include 'koneksi.php';
          ...
          ?>
                <tr>
                  ...
                  <td><?=$row['nama']?></td>
                  <td width="1"><a href="edit.php?id_kategori=<?=$row['id_kategori']?>"
                     class="btn btn-success">Edit</a></td>
                  <td width="1"><a href="delete.php?id_kategori=<?=$row['id_kategori']?>"
